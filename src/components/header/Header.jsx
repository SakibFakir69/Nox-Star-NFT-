...
function Header() {
  return (
    <div
      className={`${headerCss.Header_wrapper} section`}
    ...
    >
      ...
      <div className={headerCss.Header_Content}>
        ...
        <p>
          ...
          officiis cum obcaecati!
        </p>

        <div className={`${headerCss.clients} `}>
          <p className="Counters">
            2021+{" "}
            <span className="whitespace-nowrap md:mt-2 mt-1 sm:leading-8 leading-10">
              Clients
            </span>
          </p>
          <p className="Counters">
      ...
      <div className={headerCss.Header_image}>
        <img src={HeroImg} alt="hero-img"   style={{marginTop:"100px"}} />
